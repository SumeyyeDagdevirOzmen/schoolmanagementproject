...
public class US13TeacherExpectedData {
    ...
    public US13TeacherExpectedData() {
    }

    public US13TeacherExpectedData(String birthDay, String birthPlace, String email, String gender, boolean isAdvisorTeacher, ArrayList<Integer> lessonsIdList, String name, String password, String phoneNumber, String ssn, String surname, String username) {
    ...
    public String toString() {
        return "US13TeacherExpectedData{" +
                "birthDay='" + birthDay + '\'' +
